...
#define PLT_HTTP_DEFAULT_USER_AGENT "UPnP/1.1 NaimUPnP/" PLT_PLATINUM_SDK_VERSION_STRING
#endif

#if !defined(PLT_HTTP_DEFAULT_SERVER)
#define PLT_HTTP_DEFAULT_SERVER "UPnP/1.1 NaimUPnP/" PLT_PLATINUM_SDK_VERSION_STRING
#endif
